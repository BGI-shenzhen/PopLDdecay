...
<b> [Download](https://github.com/hewm2008/PopLDdecay/archive/v3.45.tar.gz) </b>
...
```php
	Usage: PopLDdecay -InVCF  <in.vcf.gz>  -OutStat <out.stat>
		...
		-help                 Show more help [hewm2008 v3.45]
...
------------
**v3.45** — 2026-07-16
* Performance: ~5% CPU reduction vs v3.43
* Memory: ~34% RSS reduction (160 MB → 106 MB)
